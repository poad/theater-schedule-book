...
export const DateView = (props: {
  ...
  return <>{date.getFullYear()}/{date.getMonth()}/{date.getDate()} ({dateTimeFormat.format(date)}) {date.getHours().toString().padStart(2, "0")}:{date.getMinutes().toString().padStart(2, "0")}</>;
};
